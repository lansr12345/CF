...
function displayCarDetails() {
    ...
    const telegramNumber = "01033139027"; // نفس الرقم للتلجرام
    ...
    container.innerHTML = `
        ...
        <div class="info-grid">
            ...
            <div class="info-card">
                ...
                <h3>الحالة</h3>
                <p>${car.condition === 'new' ? 'جديد' : 'مستعمل'}</p>
            </div>
        </div>
        ...
        <div class="payment-grid">
            <div class="payment-card">
                ...
                <h3>الدفع النقدي</h3>
                <p>${car.payment.cash}</p>
            </div>
            
            <div class="payment-card">
                <i class="fas fa-credit-card"></i>
                <h3>التقسيط</h3>
                <p>${car.payment.installment}</p>
            </div>
        </div>
        
        <div class="contact-buttons">
            <a href="https://wa.me/${whatsappNumber}?text=مرحباً، أريد شراء ${brand} ${car.model} (${car.year})" class="contact-btn whatsapp" target="_blank">
                <i class="fab fa-whatsapp"></i> شراء عبر واتساب
            </a>
            <a href="https://t.me/${telegramNumber}" class="contact-btn telegram" target="_blank">
                <i class="fab fa-telegram-plane"></i> شراء عبر تلجرام
            </a>
        </div>
    `;
}
...
function updateLogoBasedOnTheme() {
    ...
    // إذا لم يكن هناك عنصرين للوجو، لا تفعل شيئًا
...
function initAdvancedAnimations() {
    ...
    const images = document.querySelectorAll('.car-card-image, .car-preview-image, .car-detail-image');
    images.forEach(img => {
...
function createThemeToggle() {
    ...
    updateLogoBasedOnTheme(); // تحديث الشعار بعد تحميل الثيم
    ...
    toggleBtn.addEventListener('click', () => {
        ...
        updateLogoBasedOnTheme(); // تحديث الشعار عند تغيير الثيم
...
function initTheme() {
    const savedTheme = localStorage.getItem('carworld-theme') || 'dark';
    document.documentElement.setAttribute('data-theme', savedTheme);
    updateLogoBasedOnTheme(); // تحديث الشعار بعد تحميل الصفحة
...
window.addEventListener('load', () => {
    if (document.querySelector('.header') && !document.querySelector('.theme-toggle')) {
        createThemeToggle();
    }
});
...
// إضافة أنيميشن cardGlow فقط (بدون particles)
