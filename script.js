...
function getCountryFlagSVG(country, isStats = false) {
    ...
    const flags = {
        ...
        "كوريا الجنوبية": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3 2" width="${width}" height="${height}"><rect width="3" height="2" fill="#fff"/><circle cx="1.5" cy="1" r="0.6" fill="#C60C30"/><circle cx="1.5" cy="1" r="0.4" fill="#003478"/><g fill="#000" transform="translate(0.3,0.2)"><path d="M1.2,0.3 L1.35,0.45 L1.5,0.3 L1.65,0.45 L1.8,0.3 L1.65,0.45 L1.8,0.6 L1.65,0.75 L1.5,0.6 L1.35,0.75 L1.2,0.6 L1.35,0.45 Z"/><path d="M2.1,0.3 L2.25,0.45 L2.4,0.3 L2.55,0.45 L2.7,0.3 L2.55,0.45 L2.7,0.6 L2.55,0.75 L2.4,0.6 L2.25,0.75 L2.1,0.6 L2.25,0.45 Z"/><path d="M0.3,1.4 L0.45,1.55 L0.6,1.4 L0.75,1.55 L0.9,1.4 L0.75,1.55 L0.9,1.7 L0.75,1.85 L0.6,1.7 L0.45,1.85 L0.3,1.7 L0.45,1.55 Z"/><path d="M2.1,1.4 L2.25,1.55 L2.4,1.4 L2.55,1.55 L2.7,1.4 L2.55,1.55 L2.7,1.7 L2.55,1.85 L2.4,1.7 L2.25,1.85 L2.1,1.7 L2.25,1.55 Z"/></g></svg>`,
        "فرنسا": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3 2" width="${width}" height="${height}"><rect width="1" height="2" fill="#0055A4"/><rect x="1" width="1" height="2" fill="#fff"/><rect x="2" width="1" height="2" fill="#EF4135"/></svg>`
    };

    if (flags[country]) {
        return `<img src="data:image/svg+xml,${encodeURIComponent(flags[country])}" class="flag-img" alt="${country}">`;
    }
    return "";
}
...
const cars = {
    luxury: {
        BMW: [{
                ...
                specs: {
                    engine: "6 سلندر 3.0 لتر تيربو",
                    power: "380 حصان",
                    torque: "540 نيوتن متر",
                    acceleration: "0-100 كم/س في 5.4 ثانية",
                    topSpeed: "250 كم/س",
            ...
            },
            {
                ...
                specs: {
                    engine: "6 سلندر 3.0 لتر تيربو + هايبرد",
                    power: "380 حصان",
                    torque: "520 نيوتن متر",
                    acceleration: "0-100 كم/س في 5.2 ثانية",
                    topSpeed: "250 كم/س",
            ...
            },
            {
                ...
                specs: {
                    ...
                    acceleration: "0-100 كم/س في 6.1 ثانية",
                    topSpeed: "245 كم/س",
            ...
            },
            {
                ...
                payment: { cash: "خصم 5% على الدفع النقدي", installment: "تقسيط حتى 60 شهر، دفعة أولى 20%، فائدة 5% سنوياً" },
                specs: {
                    engine: "1.5 لتر تيربو + كهرباء",
                    power: "374 حصان",
                    torque: "570 نيوتن متر",
                    acceleration: "0-100 كم/س في 4.4 ثانية",
                    topSpeed: "250 كم/س",
        ...
        Mercedes: [{
                ...
                specs: {
                    ...
                    power: "435 حصان",
                    torque: "520 نيوتن متر",
                    acceleration: "0-100 كم/س في 4.8 ثانية",
                    topSpeed: "250 كم/س",
                    fuelConsumption: "8.9 لتر/100 كم",
            ...
            },
            {
                ...
                payment: { cash: "خصم 10% على الدفع النقدي", installment: "تقسيط حتى 48 شهر، دفعة أولى 25%، فائدة 6% سنوياً" },
                specs: {
                    engine: "V8 4.0 لتر تيربو",
                    power: "585 حصان",
                    torque: "850 نيوتن متر",
                    acceleration: "0-100 كم/س في 4.5 ثانية",
                    topSpeed: "240 كم/س",
                    fuelConsumption: "13.5 لتر/100 كم",
                    transmission: "أوتوماتيك 9 سرعات",
                    driveType: "دفع رباعي"
                },
                colors: ["أبيض"],
            ...
            },
            {
                ...
                specs: {
                    ...
                    acceleration: "0-100 كم/س في 5.6 ثانية",
                    topSpeed: "250 كم/س",
                    fuelConsumption: "9.3 لتر/100 كم",
                    transmission: "أوتوماتيك 9 سرعات",
                    driveType: "دفع رباعي"
                },
                colors: ["أسود", "فضي"],
        ...
        Audi: [{
            ...
            },
            {
                ...
                specs: {
                    ...
                    power: "340 حصان",
                    torque: "500 نيوتن متر",
                    acceleration: "0-100 كم/س في 5.9 ثانية",
                    topSpeed: "250 كم/س",
                    fuelConsumption: "9.3 لتر/100 كم",
                    transmission: "أوتوماتيك 8 سرعات",
                    driveType: "Quattro دفع رباعي"
        ...
        Lexus: [{
            ...
            payment: { cash: "خصم 5% على الدفع النقدي", installment: "تقسيط حتى 60 شهر، دفعة أولى 20%، فائدة 5% سنوياً" },
            specs: {
                engine: "2.5 لتر هايبرد",
                power: "247 حصان",
                torque: "316 نيوتن متر",
        ...
        Porsche: [{
            ...
            payment: { cash: "خصم 5% على الدفع النقدي", installment: "تقسيط حتى 60 شهر، دفعة أولى 20%، فائدة 5% سنوياً" },
            specs: {
                engine: "V6 2.9 لتر تيربو",
                power: "440 حصان",
                torque: "550 نيوتن متر",
                acceleration: "0-100 كم/س في 4.9 ثانية",
                topSpeed: "265 كم/س",
                fuelConsumption: "9.5 لتر/100 كم",
                transmission: "أوتوماتيك 8 سرعات",
                driveType: "دفع رباعي"
    ...
    medium: {
        BMW: [{
                ...
                payment: { cash: "خصم 5% على الدفع النقدي", installment: "تقسيط حتى 60 شهر، دفعة أولى 20%، فائدة 5% سنوياً" },
                specs: {
                    engine: "4 سلندر 2.0 لتر تيربو",
                    power: "184 حصان",
                    torque: "300 نيوتن متر",
                    acceleration: "0-100 كم/س في 7.1 ثانية",
                    topSpeed: "240 كم/س",
            ...
            },
            {
                ...
                specs: {
                    ...
                    acceleration: "0-100 كم/س في 6.8 ثانية",
                    topSpeed: "245 كم/س",
            ...
            },
            {
                ...
                specs: {
                    ...
                    power: "184 حصان",
                    torque: "300 نيوتن متر",
                    acceleration: "0-100 كم/س في 7.3 ثانية",
                    topSpeed: "238 كم/س",
        ...
        Mercedes: [{
                ...
                payment: { cash: "خصم 5% على الدفع النقدي", installment: "تقسيط حتى 60 شهر، دفعة أولى 20%، فائدة 5% سنوياً" },
                specs: {
                    engine: "1.5 لتر تيربو + هايبرد",
                    power: "170 حصان",
                    torque: "250 نيوتن متر",
                    acceleration: "0-100 كم/س في 8.2 ثانية",
                    topSpeed: "230 كم/س",
            ...
            },
            {
                ...
                specs: {
                    ...
                    power: "204 حصان",
                    torque: "300 نيوتن متر",
                    acceleration: "0-100 كم/س في 7.5 ثانية",
                    topSpeed: "240 كم/س",
                    fuelConsumption: "6.8 لتر/100 كم",
                    transmission: "أوتوماتيك 9 سرعات",
                    driveType: "دفع خلفي"
            ...
            },
            {
                ...
                payment: { cash: "خصم 10% على الدفع النقدي", installment: "تقسيط حتى 48 شهر، دفعة أولى 25%، فائدة 6% سنوياً" },
                specs: {
                    engine: "1.3 لتر تيربو",
                    power: "163 حصان",
                    torque: "250 نيوتن متر",
                    acceleration: "0-100 كم/س في 8.0 ثانية",
                    topSpeed: "225 كم/س",
        ...
        Audi: [{
                ...
                specs: {
                    ...
                    power: "201 حصان",
                    torque: "320 نيوتن متر",
                    acceleration: "0-100 كم/س في 7.0 ثانية",
                    topSpeed: "240 كم/س",
            ...
            },
            {
                ...
                specs: {
                    ...
                    power: "204 حصان",
                    torque: "320 نيوتن متر",
                    acceleration: "0-100 كم/س في 7.2 ثانية",
                    topSpeed: "245 كم/س",
                    fuelConsumption: "7.5 لتر/100 كم",
                    transmission: "أوتوماتيك 7 سرعات",
                    driveType: "دفع أمامي"
            ...
            },
            {
                ...
                specs: {
                    ...
                    acceleration: "0-100 كم/س في 8.2 ثانية",
                    topSpeed: "220 كم/س",
                    fuelConsumption: "6.0 لتر/100 كم",
                    transmission: "أوتوماتيك 7 سرعات",
                    driveType: "دفع أمامي"
                },
                colors: ["أزرق", "رمادي"],
            ...
            },
            {
                ...
                specs: {
                    ...
                    power: "201 حصان",
                    torque: "320 نيوتن متر",
                    acceleration: "0-100 كم/س في 7.8 ثانية",
                    topSpeed: "230 كم/س",
                    fuelConsumption: "7.9 لتر/100 كم",
                    transmission: "أوتوماتيك 7 سرعات",
                    driveType: "Quattro دفع رباعي"
                },
                colors: ["أزرق"],
        ...
        Volkswagen: [{
            ...
            },
            {
                ...
                specs: {
                    ...
                    power: "150 حصان",
                    torque: "250 نيوتن متر",
                    acceleration: "0-100 كم/س في 8.9 ثانية",
                    topSpeed: "210 كم/س",
                    fuelConsumption: "7.2 لتر/100 كم",
                    transmission: "أوتوماتيك 6 سرعات",
                    driveType: "دفع أمامي"
        ...
        Mazda: [{
            ...
            },
            {
                ...
                specs: {
                    ...
                    power: "187 حصان",
                    torque: "250 نيوتن متر",
                    acceleration: "0-100 كم/س في 8.8 ثانية",
                    topSpeed: "210 كم/س",
                    fuelConsumption: "8.0 لتر/100 كم",
                    transmission: "أوتوماتيك 6 سرعات",
                    driveType: "دفع أمامي"
                },
                colors: ["أحمر"],
    ...
    economy: {
        Toyota: [{
                ...
                specs: {
                    engine: "1.6 لتر",
                    power: "120 حصان",
                    torque: "160 نيوتن متر",
                    acceleration: "0-100 كم/س في 10.5 ثانية",
                    topSpeed: "190 كم/س",
                    fuelConsumption: "6.5 لتر/100 كم",
                    transmission: "CVT أوتوماتيك",
                    driveType: "دفع أمامي"
            ...
            },
            {
                ...
                specs: {
                    engine: "1.5 لتر",
                    power: "106 حصان",
                    torque: "140 نيوتن متر",
                    acceleration: "0-100 كم/س في 11.2 ثانية",
                    topSpeed: "180 كم/س",
            ...
            },
            {
                ...
                specs: {
                    ...
                    acceleration: "0-100 كم/س في 9.5 ثانية",
                    topSpeed: "195 كم/س",
                    fuelConsumption: "7.8 لتر/100 كم",
                    transmission: "CVT أوتوماتيك",
                    driveType: "دفع أمامي"
            ...
            },
            {
                ...
                payment: { cash: "خصم 5% على الدفع النقدي", installment: "تقسيط حتى 60 شهر، دفعة أولى 20%، فائدة 5% سنوياً" },
                specs: {
                    engine: "1.5 لتر هايبرد",
                    power: "100 حصان",
                    torque: "120 نيوتن متر",
                    acceleration: "0-100 كم/س في 12.0 ثانية",
                    topSpeed: "170 كم/س",
                    fuelConsumption: "3.5 لتر/100 كم",
                    transmission: "CVT أوتوماتيك",
                    driveType: "دفع أمامي"
                },
                colors: ["أخضر"],
        ...
        Hyundai: [{
                ...
                specs: {
                    ...
                    power: "100 حصان",
                    torque: "140 نيوتن متر",
                    acceleration: "0-100 كم/س في 12.5 ثانية",
                    topSpeed: "175 كم/س",
                    fuelConsumption: "6.8 لتر/100 كم",
                    transmission: "أوتوماتيك 4 سرعات",
                    driveType: "دفع أمامي"
                },
                colors: ["فضي", "أحمر"],
            ...
            },
            {
                ...
                specs: {
                    engine: "1.6 لتر",
                    power: "128 حصان",
                    torque: "170 نيوتن متر",
                    acceleration: "0-100 كم/س في 10.2 ثانية",
                    topSpeed: "200 كم/س",
                    fuelConsumption: "7.0 لتر/100 كم",
                    transmission: "أوتوماتيك 6 سرعات",
                    driveType: "دفع أمامي"
            ...
            },
            {
                ...
                specs: {
                    ...
                    acceleration: "0-100 كم/س في 11.5 ثانية",
                    topSpeed: "185 كم/س",
                    fuelConsumption: "7.2 لتر/100 كم",
                    transmission: "أوتوماتيك 6 سرعات",
                    driveType: "دفع أمامي"
            ...
            },
            {
                ...
                specs: {
                    ...
                    power: "177 حصان",
                    torque: "270 نيوتن متر",
                    acceleration: "0-100 كم/س في 9.2 ثانية",
                    topSpeed: "205 كم/س",
                    fuelConsumption: "8.0 لتر/100 كم",
                    transmission: "أوتوماتيك 7 سرعات",
                    driveType: "دفع أمامي"
            ...
            },
            {
                ...
                specs: {
                    ...
                    power: "87 حصان",
                    torque: "120 نيوتن متر",
                    acceleration: "0-100 كم/س في 14.0 ثانية",
                    topSpeed: "160 كم/س",
        ...
        Kia: [{
                ...
                specs: {
                    ...
                    power: "100 حصان",
                    torque: "140 نيوتن متر",
                    acceleration: "0-100 كم/س في 12.8 ثانية",
                    topSpeed: "170 كم/س",
                    fuelConsumption: "6.5 لتر/100 كم",
                    transmission: "أوتوماتيك 4 سرعات",
                    driveType: "دفع أمامي"
            ...
            },
            {
                ...
                specs: {
                    engine: "1.0 لتر",
                    power: "67 حصان",
                    torque: "100 نيوتن متر",
                    acceleration: "0-100 كم/س في 15.0 ثانية",
                    topSpeed: "155 كم/س",
        ...
        Nissan: [{
                ...
                specs: {
                    ...
                    power: "124 حصان",
                    torque: "170 نيوتن متر",
                    acceleration: "0-100 كم/س في 10.8 ثانية",
                    topSpeed: "190 كم/س",
                    fuelConsumption: "7.0 لتر/100 كم",
                    transmission: "CVT أوتوماتيك",
                    driveType: "دفع أمامي"
            ...
            },
            {
                ...
                specs: {
                    ...
                    power: "140 حصان",
                    torque: "240 نيوتن متر",
                    acceleration: "0-100 كم/س في 9.8 ثانية",
                    topSpeed: "200 كم/س",
                    fuelConsumption: "7.5 لتر/100 كم",
                    transmission: "CVT أوتوماتيك",
                    driveType: "دفع أمامي"
            ...
            },
            {
                ...
                specs: {
                    ...
                    power: "71 حصان",
                    torque: "100 نيوتن متر",
                    acceleration: "0-100 كم/س في 14.5 ثانية",
                    topSpeed: "165 كم/س",
                    fuelConsumption: "5.8 لتر/100 كم",
                    transmission: "أوتوماتيك 4 سرعات",
                    driveType: "دفع أمامي"
        ...
        Renault: [{
            ...
            },
            {
                ...
                payment: { cash: "خصم 5% على الدفع النقدي", installment: "تقسيط حتى 60 شهر، دفعة أولى 20%، فائدة 5% سنوياً" },
                specs: {
                    engine: "1.0 لتر تيربو",
                    power: "100 حصان",
                    torque: "160 نيوتن متر",
                    acceleration: "0-100 كم/س في 11.2 ثانية",
                    topSpeed: "185 كم/س",
                    fuelConsumption: "5.5 لتر/100 كم",
                    transmission: "أوتوماتيك 5 سرعات",
                    driveType: "دفع أمامي"
                },
                colors: ["أحمر"],
        ...
        Suzuki: [{
                ...
                specs: {
                    ...
                    power: "83 حصان",
                    torque: "120 نيوتن متر",
                    acceleration: "0-100 كم/س في 13.5 ثانية",
                    topSpeed: "170 كم/س",
                    fuelConsumption: "5.2 لتر/100 كم",
                    transmission: "CVT أوتوماتيك",
                    driveType: "دفع أمامي"
...
function initAdvancedAnimations() {
    const cards = document.querySelectorAll('.car-card, .car-preview-card, .feature-card');
...
function createThemeToggle() {
    ...
    toggleBtn.setAttribute('aria-label', 'تبديل الوضع الليلي/النهاري');
    toggleBtn.innerHTML = '<i class="fas fa-moon"></i>';

    header.insertBefore(toggleBtn, header.querySelector('.nav'));

    const savedTheme = localStorage.getItem('carworld-theme') || 'dark';
    ...
    toggleBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('carworld-theme', newTheme);
...
function updateToggleIcon(theme) {
    ...
    if (toggleBtn) {
        toggleBtn.className = theme === 'dark' ? 'fas fa-moon' : 'fas fa-sun';
    }
}
...
document.addEventListener("DOMContentLoaded", function() {
    console.log('✅ Car World - النسخة النهائية');
